...
{
    _matrix.row_pointer.assign(rows, 0);
...
Matrix_dense<T> Matrix_sparse::convert_to_dense()
{

    Matrix_dense A(_rows, _cols);
    A.fill(0);
...
vector<T> Matrix_sparse::get_diag()
{
